...
/**
 * Base class that represents a query for the 'siga_turno' table.
 *
 * 
 *
 * This class was autogenerated by Propel 1.6.6-dev on:
 *
 * Wed Aug 29 11:49:22 2012
 *
 * @method     TurnoQuery orderById($order = Criteria::ASC) Order by the id column
 * @method     TurnoQuery orderByNombre($order = Criteria::ASC) Order by the nombre column
 * @method     TurnoQuery orderByCreatedAt($order = Criteria::ASC) Order by the created_at column
 * @method     TurnoQuery orderByUpdatedAt($order = Criteria::ASC) Order by the updated_at column
 *
 * @method     TurnoQuery groupById() Group by the id column
 * @method     TurnoQuery groupByNombre() Group by the nombre column
 * @method     TurnoQuery groupByCreatedAt() Group by the created_at column
 * @method     TurnoQuery groupByUpdatedAt() Group by the updated_at column
 *
 ...
 * @method     Turno findOneByNombre(string $nombre) Return the first Turno filtered by the nombre column
 * @method     Turno findOneByCreatedAt(string $created_at) Return the first Turno filtered by the created_at column
 * @method     Turno findOneByUpdatedAt(string $updated_at) Return the first Turno filtered by the updated_at column
 *
 * @method     array findById(int $id) Return Turno objects filtered by the id column
 * @method     array findByNombre(string $nombre) Return Turno objects filtered by the nombre column
 * @method     array findByCreatedAt(string $created_at) Return Turno objects filtered by the created_at column
 * @method     array findByUpdatedAt(string $updated_at) Return Turno objects filtered by the updated_at column
 *
...
abstract class BaseTurnoQuery extends ModelCriteria
{
	 ...
	 *
	 * @return    Turno|array|mixed the result, formatted by the current formatter
	 */
	...
	public function filterByNombre($nombre = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(TurnoPeer::NOMBRE, $nombre, $comparison);
	}
	...
	public function filterByCreatedAt($createdAt = null, $comparison = null)
	{
		if (is_array($createdAt)) {
			...
			if (isset($createdAt['min'])) {
				$this->addUsingAlias(TurnoPeer::CREATED_AT, $createdAt['min'], Criteria::GREATER_EQUAL);
				$useMinMax = true;
			}
			if (isset($createdAt['max'])) {
				$this->addUsingAlias(TurnoPeer::CREATED_AT, $createdAt['max'], Criteria::LESS_EQUAL);
				$useMinMax = true;
			}
			if ($useMinMax) {
				return $this;
		...
		return $this->addUsingAlias(TurnoPeer::CREATED_AT, $createdAt, $comparison);
	}
	...
	public function filterByUpdatedAt($updatedAt = null, $comparison = null)
	{
		if (is_array($updatedAt)) {
			...
			if (isset($updatedAt['min'])) {
				$this->addUsingAlias(TurnoPeer::UPDATED_AT, $updatedAt['min'], Criteria::GREATER_EQUAL);
				$useMinMax = true;
			}
			if (isset($updatedAt['max'])) {
				$this->addUsingAlias(TurnoPeer::UPDATED_AT, $updatedAt['max'], Criteria::LESS_EQUAL);
				$useMinMax = true;
			}
			if ($useMinMax) {
				return $this;
		...
		return $this->addUsingAlias(TurnoPeer::UPDATED_AT, $updatedAt, $comparison);
	}
