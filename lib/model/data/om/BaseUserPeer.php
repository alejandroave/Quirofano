...
/**
 * Base static class for performing query and update operations on the 'hc_usuarios' table.
 *
 *
 *
...
abstract class BaseUserPeer
{
    ...
    const NOMBRE = 'hc_usuarios.NOMBRE';

    /** the column name for the PASS field */
    const PASS = 'hc_usuarios.PASS';

    /** the column name for the TIPO field */
    const TIPO = 'hc_usuarios.TIPO';

    /** the column name for the ID field */
    const ID = 'hc_usuarios.ID';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Nombre', 'Pass', 'Tipo', 'Id', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('nombre', 'pass', 'tipo', 'id', ),
        BasePeer::TYPE_COLNAME => array (UserPeer::NOMBRE, UserPeer::PASS, UserPeer::TIPO, UserPeer::ID, ),
        BasePeer::TYPE_RAW_COLNAME => array ('NOMBRE', 'PASS', 'TIPO', 'ID', ),
        BasePeer::TYPE_FIELDNAME => array ('nombre', 'pass', 'tipo', 'id', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Nombre' => 0, 'Pass' => 1, 'Tipo' => 2, 'Id' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('nombre' => 0, 'pass' => 1, 'tipo' => 2, 'id' => 3, ),
        BasePeer::TYPE_COLNAME => array (UserPeer::NOMBRE => 0, UserPeer::PASS => 1, UserPeer::TIPO => 2, UserPeer::ID => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('NOMBRE' => 0, 'PASS' => 1, 'TIPO' => 2, 'ID' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('nombre' => 0, 'pass' => 1, 'tipo' => 2, 'id' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(UserPeer::NOMBRE);
            $criteria->addSelectColumn(UserPeer::PASS);
            $criteria->addSelectColumn(UserPeer::TIPO);
    ...
    /**
     * Method to invalidate the instance pool of all tables related to hc_usuarios
    ...
    /**
     * Deletes all rows from the hc_usuarios table.
     *
     * @param      PropelPDO $con the connection to use
     * @return int             The number of affected rows (if supported by underlying database driver).
