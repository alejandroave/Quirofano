...
abstract class BaseAgendaPeer
{
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        ProcedimientoPeer::addSelectColumns($criteria);
        $startcol5 = $startcol4 + ProcedimientoPeer::NUM_HYDRATE_COLUMNS;

        CausadiferidoPeer::addSelectColumns($criteria);
        $startcol6 = $startcol5 + CausadiferidoPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            $key4 = ProcedimientoPeer::getPrimaryKeyHashFromRow($row, $startcol4);
            if ($key4 !== null) {
                $obj4 = ProcedimientoPeer::getInstanceFromPool($key4);
                if (!$obj4) {
                    ...
                    ProcedimientoPeer::addInstanceToPool($obj4, $key4);
                } // if obj4 loaded

                // Add the $obj1 (Agenda) to the collection in $obj4 (Procedimiento)
                $obj4->addAgenda($obj1);
            } // if joined row not null

            // Add objects for joined Causadiferido rows

            $key5 = CausadiferidoPeer::getPrimaryKeyHashFromRow($row, $startcol5);
            if ($key5 !== null) {
                $obj5 = CausadiferidoPeer::getInstanceFromPool($key5);
                if (!$obj5) {
                    ...
                    CausadiferidoPeer::addInstanceToPool($obj5, $key5);
                } // if obj5 loaded

                // Add the $obj1 (Agenda) to the collection in $obj5 (Causadiferido)
                $obj5->addAgenda($obj1);
            } // if joined row not null
    ...
    public static function doSelectJoinAllExceptSalaquirurgica(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        ProcedimientoPeer::addSelectColumns($criteria);
        $startcol4 = $startcol3 + ProcedimientoPeer::NUM_HYDRATE_COLUMNS;

        CausadiferidoPeer::addSelectColumns($criteria);
        $startcol5 = $startcol4 + CausadiferidoPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if (null !== ($obj1 = AgendaPeer::getInstanceFromPool($key1))) {
                ...
                $key3 = ProcedimientoPeer::getPrimaryKeyHashFromRow($row, $startcol3);
                if ($key3 !== null) {
                    $obj3 = ProcedimientoPeer::getInstanceFromPool($key3);
                    if (!$obj3) {
                    ...
                    $obj3 = new $cls();
                    $obj3->hydrate($row, $startcol3);
                    ProcedimientoPeer::addInstanceToPool($obj3, $key3);
                } // if $obj3 already loaded

                // Add the $obj1 (Agenda) to the collection in $obj3 (Procedimiento)
                $obj3->addAgenda($obj1);
                ...
                $key4 = CausadiferidoPeer::getPrimaryKeyHashFromRow($row, $startcol4);
                if ($key4 !== null) {
                    $obj4 = CausadiferidoPeer::getInstanceFromPool($key4);
                    if (!$obj4) {
                    ...
                    $obj4 = new $cls();
                    $obj4->hydrate($row, $startcol4);
                    CausadiferidoPeer::addInstanceToPool($obj4, $key4);
                } // if $obj4 already loaded

                // Add the $obj1 (Agenda) to the collection in $obj4 (Causadiferido)
                $obj4->addAgenda($obj1);
