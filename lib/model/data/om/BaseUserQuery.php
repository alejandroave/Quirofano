 ...
 * @method User findOneByTipo(string $tipo) Return the first User filtered by the tipo column
 ...
 * @method array findByTipo(string $tipo) Return User objects filtered by the tipo column
