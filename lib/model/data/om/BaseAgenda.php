...
abstract class BaseAgenda extends BaseObject implements Persistent
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->paciente_name = ($row[$startcol + 16] !== null) ? (string) $row[$startcol + 16] : null;
            $this->paciente_id = ($row[$startcol + 17] !== null) ? (int) $row[$startcol + 17] : null;
            $this->edad = ($row[$startcol + 18] !== null) ? (string) $row[$startcol + 18] : null;
            $this->genero = ($row[$startcol + 19] !== null) ? (string) $row[$startcol + 19] : null;
            $this->genero_id = ($row[$startcol + 20] !== null) ? (int) $row[$startcol + 20] : null;
            $this->registro = ($row[$startcol + 21] !== null) ? (string) $row[$startcol + 21] : null;
            $this->servicio = ($row[$startcol + 22] !== null) ? (int) $row[$startcol + 22] : null;
            $this->anestesia_id = ($row[$startcol + 23] !== null) ? (int) $row[$startcol + 23] : null;
            $this->anestesia_empleada = ($row[$startcol + 24] !== null) ? (string) $row[$startcol + 24] : null;
            $this->ev_adversos_anestesia = ($row[$startcol + 25] !== null) ? (string) $row[$startcol + 25] : null;
            $this->observaciones = ($row[$startcol + 26] !== null) ? (string) $row[$startcol + 26] : null;
            $this->requerimiento = ($row[$startcol + 27] !== null) ? (string) $row[$startcol + 27] : null;
            $this->req_insumos = ($row[$startcol + 28] !== null) ? (string) $row[$startcol + 28] : null;
            $this->req_hemoderiv = ($row[$startcol + 29] !== null) ? (string) $row[$startcol + 29] : null;
            $this->req_laboratorio = ($row[$startcol + 30] !== null) ? (string) $row[$startcol + 30] : null;
            $this->req_anestesico = ($row[$startcol + 31] !== null) ? (string) $row[$startcol + 31] : null;
            $this->status = ($row[$startcol + 32] !== null) ? (int) $row[$startcol + 32] : null;
            $this->causa_diferido_id = ($row[$startcol + 33] !== null) ? (int) $row[$startcol + 33] : null;
            $this->solicitado = ($row[$startcol + 34] !== null) ? (boolean) $row[$startcol + 34] : null;
            $this->riesgoqx_id = ($row[$startcol + 35] !== null) ? (int) $row[$startcol + 35] : null;
            $this->contaminacionqx_id = ($row[$startcol + 36] !== null) ? (int) $row[$startcol + 36] : null;
            $this->eventoqx_id = ($row[$startcol + 37] !== null) ? (int) $row[$startcol + 37] : null;
            $this->complicaciones = ($row[$startcol + 38] !== null) ? (string) $row[$startcol + 38] : null;
            $this->val_pre_anestesica = ($row[$startcol + 39] !== null) ? (string) $row[$startcol + 39] : null;
            $this->reintervencion = ($row[$startcol + 40] !== null) ? (boolean) $row[$startcol + 40] : null;
            $this->permisos = $row[$startcol + 41];
            $this->tipo_proc_id = ($row[$startcol + 42] !== null) ? (int) $row[$startcol + 42] : null;
            $this->atencion_id = ($row[$startcol + 43] !== null) ? (int) $row[$startcol + 43] : null;
            $this->tiempo_fuera = ($row[$startcol + 44] !== null) ? (boolean) $row[$startcol + 44] : null;
            $this->procedencia = ($row[$startcol + 45] !== null) ? (string) $row[$startcol + 45] : null;
            $this->clasificacionqx = ($row[$startcol + 46] !== null) ? (int) $row[$startcol + 46] : null;
            $this->region_px = ($row[$startcol + 47] !== null) ? (int) $row[$startcol + 47] : null;
            $this->extension_px = ($row[$startcol + 48] !== null) ? (int) $row[$startcol + 48] : null;
            $this->anexo_detalle = ($row[$startcol + 49] !== null) ? (int) $row[$startcol + 49] : null;
            $this->destino_px = ($row[$startcol + 50] !== null) ? (int) $row[$startcol + 50] : null;
            $this->liberacion_sala = ($row[$startcol + 51] !== null) ? (string) $row[$startcol + 51] : null;
            $this->tiempo_est = ($row[$startcol + 52] !== null) ? (string) $row[$startcol + 52] : null;
            $this->riesgo_qx_pre = ($row[$startcol + 53] !== null) ? (string) $row[$startcol + 53] : null;
            $this->show_in_index = ($row[$startcol + 54] !== null) ? (boolean) $row[$startcol + 54] : null;
            $this->protocolo = ($row[$startcol + 55] !== null) ? (boolean) $row[$startcol + 55] : null;
            $this->cancelada = ($row[$startcol + 56] !== null) ? (boolean) $row[$startcol + 56] : null;
            $this->created_at = ($row[$startcol + 57] !== null) ? (string) $row[$startcol + 57] : null;
            $this->updated_at = ($row[$startcol + 58] !== null) ? (string) $row[$startcol + 58] : null;
            $this->resetModified();
            ...
            return $startcol + 59; // 59 = AgendaPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[16] => $this->getPacienteName(),
            $keys[17] => $this->getPacienteId(),
            $keys[18] => $this->getEdad(),
            $keys[19] => $this->getGenero(),
            $keys[20] => $this->getGeneroId(),
            $keys[21] => $this->getRegistro(),
            $keys[22] => $this->getServicio(),
            $keys[23] => $this->getAnestesiaId(),
            $keys[24] => $this->getAnestesiaEmpleada(),
            $keys[25] => $this->getEvAdversosAnestesia(),
            $keys[26] => $this->getObservaciones(),
            $keys[27] => $this->getRequerimiento(),
            $keys[28] => $this->getReqInsumos(),
            $keys[29] => $this->getReqHemoderiv(),
            $keys[30] => $this->getReqLaboratorio(),
            $keys[31] => $this->getReqAnestesico(),
            $keys[32] => $this->getStatus(),
            $keys[33] => $this->getCausaDiferidoId(),
            $keys[34] => $this->getSolicitado(),
            $keys[35] => $this->getRiesgoqxId(),
            $keys[36] => $this->getContaminacionqxId(),
            $keys[37] => $this->getEventoqxId(),
            $keys[38] => $this->getComplicaciones(),
            $keys[39] => $this->getValPreAnestesica(),
            $keys[40] => $this->getReintervencion(),
            $keys[41] => $this->getPermisos(),
            $keys[42] => $this->getTipoProcId(),
            $keys[43] => $this->getAtencionId(),
            $keys[44] => $this->getTiempoFuera(),
            $keys[45] => $this->getProcedencia(),
            $keys[46] => $this->getClasificacionqx(),
            $keys[47] => $this->getRegionPx(),
            $keys[48] => $this->getExtensionPx(),
            $keys[49] => $this->getAnexoDetalle(),
            $keys[50] => $this->getDestinoPx(),
            $keys[51] => $this->getLiberacionSala(),
            $keys[52] => $this->getTiempoEst(),
            $keys[53] => $this->getRiesgoQxPre(),
            $keys[54] => $this->getShowInIndex(),
            $keys[55] => $this->getProtocolo(),
            $keys[56] => $this->getCancelada(),
            $keys[57] => $this->getCreatedAt(),
            $keys[58] => $this->getUpdatedAt(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[16], $arr)) $this->setPacienteName($arr[$keys[16]]);
        if (array_key_exists($keys[17], $arr)) $this->setPacienteId($arr[$keys[17]]);
        if (array_key_exists($keys[18], $arr)) $this->setEdad($arr[$keys[18]]);
        if (array_key_exists($keys[19], $arr)) $this->setGenero($arr[$keys[19]]);
        if (array_key_exists($keys[20], $arr)) $this->setGeneroId($arr[$keys[20]]);
        if (array_key_exists($keys[21], $arr)) $this->setRegistro($arr[$keys[21]]);
        if (array_key_exists($keys[22], $arr)) $this->setServicio($arr[$keys[22]]);
        if (array_key_exists($keys[23], $arr)) $this->setAnestesiaId($arr[$keys[23]]);
        if (array_key_exists($keys[24], $arr)) $this->setAnestesiaEmpleada($arr[$keys[24]]);
        if (array_key_exists($keys[25], $arr)) $this->setEvAdversosAnestesia($arr[$keys[25]]);
        if (array_key_exists($keys[26], $arr)) $this->setObservaciones($arr[$keys[26]]);
        if (array_key_exists($keys[27], $arr)) $this->setRequerimiento($arr[$keys[27]]);
        if (array_key_exists($keys[28], $arr)) $this->setReqInsumos($arr[$keys[28]]);
        if (array_key_exists($keys[29], $arr)) $this->setReqHemoderiv($arr[$keys[29]]);
        if (array_key_exists($keys[30], $arr)) $this->setReqLaboratorio($arr[$keys[30]]);
        if (array_key_exists($keys[31], $arr)) $this->setReqAnestesico($arr[$keys[31]]);
        if (array_key_exists($keys[32], $arr)) $this->setStatus($arr[$keys[32]]);
        if (array_key_exists($keys[33], $arr)) $this->setCausaDiferidoId($arr[$keys[33]]);
        if (array_key_exists($keys[34], $arr)) $this->setSolicitado($arr[$keys[34]]);
        if (array_key_exists($keys[35], $arr)) $this->setRiesgoqxId($arr[$keys[35]]);
        if (array_key_exists($keys[36], $arr)) $this->setContaminacionqxId($arr[$keys[36]]);
        if (array_key_exists($keys[37], $arr)) $this->setEventoqxId($arr[$keys[37]]);
        if (array_key_exists($keys[38], $arr)) $this->setComplicaciones($arr[$keys[38]]);
        if (array_key_exists($keys[39], $arr)) $this->setValPreAnestesica($arr[$keys[39]]);
        if (array_key_exists($keys[40], $arr)) $this->setReintervencion($arr[$keys[40]]);
        if (array_key_exists($keys[41], $arr)) $this->setPermisos($arr[$keys[41]]);
        if (array_key_exists($keys[42], $arr)) $this->setTipoProcId($arr[$keys[42]]);
        if (array_key_exists($keys[43], $arr)) $this->setAtencionId($arr[$keys[43]]);
        if (array_key_exists($keys[44], $arr)) $this->setTiempoFuera($arr[$keys[44]]);
        if (array_key_exists($keys[45], $arr)) $this->setProcedencia($arr[$keys[45]]);
        if (array_key_exists($keys[46], $arr)) $this->setClasificacionqx($arr[$keys[46]]);
        if (array_key_exists($keys[47], $arr)) $this->setRegionPx($arr[$keys[47]]);
        if (array_key_exists($keys[48], $arr)) $this->setExtensionPx($arr[$keys[48]]);
        if (array_key_exists($keys[49], $arr)) $this->setAnexoDetalle($arr[$keys[49]]);
        if (array_key_exists($keys[50], $arr)) $this->setDestinoPx($arr[$keys[50]]);
        if (array_key_exists($keys[51], $arr)) $this->setLiberacionSala($arr[$keys[51]]);
        if (array_key_exists($keys[52], $arr)) $this->setTiempoEst($arr[$keys[52]]);
        if (array_key_exists($keys[53], $arr)) $this->setRiesgoQxPre($arr[$keys[53]]);
        if (array_key_exists($keys[54], $arr)) $this->setShowInIndex($arr[$keys[54]]);
        if (array_key_exists($keys[55], $arr)) $this->setProtocolo($arr[$keys[55]]);
        if (array_key_exists($keys[56], $arr)) $this->setCancelada($arr[$keys[56]]);
        if (array_key_exists($keys[57], $arr)) $this->setCreatedAt($arr[$keys[57]]);
        if (array_key_exists($keys[58], $arr)) $this->setUpdatedAt($arr[$keys[58]]);
    }
