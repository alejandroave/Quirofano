...
abstract class BaseAgenda extends BaseObject implements Persistent
{
    ...
    /**
     * The value for the fecha_control field.
     * @var        string
     */
    protected $fecha_control;
    ...
    /**
     * Get the [optionally formatted] temporal [fecha_control] column value.
     *
     *
     * @param string $format The date/time format string (either date()-style or strftime()-style).
     *				 If format is null, then the raw DateTime object will be returned.
     ...
     * @throws PropelException - if unable to parse/validate the date/time value.
     */
    public function getFechaControl($format = 'Y-m-d')
    {
        if ($this->fecha_control === null) {
            return null;
        }

        if ($this->fecha_control === '0000-00-00') {
            // while technically this is not a default value of null,
            // this seems to be closest in meaning.
            return null;
        } else {
            try {
                $dt = new DateTime($this->fecha_control);
            } catch (Exception $x) {
                throw new PropelException("Internally stored date/time/timestamp value could not be converted to DateTime: " . var_export($this->fecha_control, true), $x);
            }
        }
    ...
    /**
     * Sets the value of [fecha_control] column to a normalized version of the date/time value specified.
     *
     * @param mixed $v string, integer (timestamp), or DateTime value.
     *               Empty strings are treated as null.
     * @return Agenda The current object (for fluent API support)
     */
    public function setFechaControl($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->fecha_control !== null || $dt !== null) {
            $currentDateAsString = ($this->fecha_control !== null && $tmpDt = new DateTime($this->fecha_control)) ? $tmpDt->format('Y-m-d') : null;
            $newDateAsString = $dt ? $dt->format('Y-m-d') : null;
            if ($currentDateAsString !== $newDateAsString) {
                $this->fecha_control = $newDateAsString;
                $this->modifiedColumns[] = AgendaPeer::FECHA_CONTROL;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->fecha_control = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->hora = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->inicio = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->last_time = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            $this->ingreso = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->sala_id = ($row[$startcol + 7] !== null) ? (int) $row[$startcol + 7] : null;
            $this->quirofano_id = ($row[$startcol + 8] !== null) ? (int) $row[$startcol + 8] : null;
            $this->egreso = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
            $this->cie9mc = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            $this->cie9mc_id = ($row[$startcol + 11] !== null) ? (string) $row[$startcol + 11] : null;
            $this->cx_realizada = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
            $this->cx_realizada_id = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
            $this->tipo_cx = ($row[$startcol + 14] !== null) ? (int) $row[$startcol + 14] : null;
            $this->diagnostico = ($row[$startcol + 15] !== null) ? (string) $row[$startcol + 15] : null;
            $this->diagnostico_id = ($row[$startcol + 16] !== null) ? (string) $row[$startcol + 16] : null;
            $this->medico_name = ($row[$startcol + 17] !== null) ? (string) $row[$startcol + 17] : null;
            $this->paciente_name = ($row[$startcol + 18] !== null) ? (string) $row[$startcol + 18] : null;
            $this->paciente_id = ($row[$startcol + 19] !== null) ? (int) $row[$startcol + 19] : null;
            $this->edad = ($row[$startcol + 20] !== null) ? (string) $row[$startcol + 20] : null;
            $this->genero = ($row[$startcol + 21] !== null) ? (string) $row[$startcol + 21] : null;
            $this->genero_id = ($row[$startcol + 22] !== null) ? (int) $row[$startcol + 22] : null;
            $this->registro = ($row[$startcol + 23] !== null) ? (string) $row[$startcol + 23] : null;
            $this->servicio = ($row[$startcol + 24] !== null) ? (int) $row[$startcol + 24] : null;
            $this->anestesia_id = ($row[$startcol + 25] !== null) ? (int) $row[$startcol + 25] : null;
            $this->anestesia_empleada = ($row[$startcol + 26] !== null) ? (string) $row[$startcol + 26] : null;
            $this->ev_adversos_anestesia = ($row[$startcol + 27] !== null) ? (string) $row[$startcol + 27] : null;
            $this->observaciones = ($row[$startcol + 28] !== null) ? (string) $row[$startcol + 28] : null;
            $this->requerimiento = ($row[$startcol + 29] !== null) ? (string) $row[$startcol + 29] : null;
            $this->req_insumos = ($row[$startcol + 30] !== null) ? (string) $row[$startcol + 30] : null;
            $this->req_hemoderiv = ($row[$startcol + 31] !== null) ? (string) $row[$startcol + 31] : null;
            $this->req_laboratorio = ($row[$startcol + 32] !== null) ? (string) $row[$startcol + 32] : null;
            $this->req_anestesico = ($row[$startcol + 33] !== null) ? (string) $row[$startcol + 33] : null;
            $this->status = ($row[$startcol + 34] !== null) ? (int) $row[$startcol + 34] : null;
            $this->causa_diferido_id = ($row[$startcol + 35] !== null) ? (int) $row[$startcol + 35] : null;
            $this->solicitado = ($row[$startcol + 36] !== null) ? (boolean) $row[$startcol + 36] : null;
            $this->riesgoqx_id = ($row[$startcol + 37] !== null) ? (int) $row[$startcol + 37] : null;
            $this->contaminacionqx_id = ($row[$startcol + 38] !== null) ? (int) $row[$startcol + 38] : null;
            $this->eventoqx_id = ($row[$startcol + 39] !== null) ? (int) $row[$startcol + 39] : null;
            $this->complicaciones = ($row[$startcol + 40] !== null) ? (string) $row[$startcol + 40] : null;
            $this->val_pre_anestesica = ($row[$startcol + 41] !== null) ? (string) $row[$startcol + 41] : null;
            $this->reintervencion = ($row[$startcol + 42] !== null) ? (boolean) $row[$startcol + 42] : null;
            $this->permisos = $row[$startcol + 43];
            $this->tipo_proc_id = ($row[$startcol + 44] !== null) ? (int) $row[$startcol + 44] : null;
            $this->atencion_id = ($row[$startcol + 45] !== null) ? (int) $row[$startcol + 45] : null;
            $this->tiempo_fuera = ($row[$startcol + 46] !== null) ? (boolean) $row[$startcol + 46] : null;
            $this->procedencia = ($row[$startcol + 47] !== null) ? (string) $row[$startcol + 47] : null;
            $this->clasificacionqx = ($row[$startcol + 48] !== null) ? (int) $row[$startcol + 48] : null;
            $this->region_px = ($row[$startcol + 49] !== null) ? (int) $row[$startcol + 49] : null;
            $this->extension_px = ($row[$startcol + 50] !== null) ? (int) $row[$startcol + 50] : null;
            $this->anexo_detalle = ($row[$startcol + 51] !== null) ? (int) $row[$startcol + 51] : null;
            $this->destino_px = ($row[$startcol + 52] !== null) ? (int) $row[$startcol + 52] : null;
            $this->liberacion_sala = ($row[$startcol + 53] !== null) ? (string) $row[$startcol + 53] : null;
            $this->tiempo_est = ($row[$startcol + 54] !== null) ? (string) $row[$startcol + 54] : null;
            $this->riesgo_qx_pre = ($row[$startcol + 55] !== null) ? (string) $row[$startcol + 55] : null;
            $this->show_in_index = ($row[$startcol + 56] !== null) ? (boolean) $row[$startcol + 56] : null;
            $this->protocolo = ($row[$startcol + 57] !== null) ? (boolean) $row[$startcol + 57] : null;
            $this->cancelada = ($row[$startcol + 58] !== null) ? (boolean) $row[$startcol + 58] : null;
            $this->created_at = ($row[$startcol + 59] !== null) ? (string) $row[$startcol + 59] : null;
            $this->updated_at = ($row[$startcol + 60] !== null) ? (string) $row[$startcol + 60] : null;
            $this->resetModified();
            ...
            return $startcol + 61; // 61 = AgendaPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(AgendaPeer::FECHA_CONTROL)) {
            $modifiedColumns[':p' . $index++]  = '`FECHA_CONTROL`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`PROGRAMACION`':
                        ...
                        break;
                    case '`FECHA_CONTROL`':
                        $stmt->bindValue($identifier, $this->fecha_control, PDO::PARAM_STR);
                        break;
                    case '`HORA`':
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getFechaControl(),
            $keys[3] => $this->getHora(),
            $keys[4] => $this->getInicio(),
            $keys[5] => $this->getLastTime(),
            $keys[6] => $this->getIngreso(),
            $keys[7] => $this->getSalaId(),
            $keys[8] => $this->getQuirofanoId(),
            $keys[9] => $this->getEgreso(),
            $keys[10] => $this->getCie9mc(),
            $keys[11] => $this->getCie9mcId(),
            $keys[12] => $this->getCxRealizada(),
            $keys[13] => $this->getCxRealizadaId(),
            $keys[14] => $this->getTipoCx(),
            $keys[15] => $this->getDiagnostico(),
            $keys[16] => $this->getDiagnosticoId(),
            $keys[17] => $this->getMedicoName(),
            $keys[18] => $this->getPacienteName(),
            $keys[19] => $this->getPacienteId(),
            $keys[20] => $this->getEdad(),
            $keys[21] => $this->getGenero(),
            $keys[22] => $this->getGeneroId(),
            $keys[23] => $this->getRegistro(),
            $keys[24] => $this->getServicio(),
            $keys[25] => $this->getAnestesiaId(),
            $keys[26] => $this->getAnestesiaEmpleada(),
            $keys[27] => $this->getEvAdversosAnestesia(),
            $keys[28] => $this->getObservaciones(),
            $keys[29] => $this->getRequerimiento(),
            $keys[30] => $this->getReqInsumos(),
            $keys[31] => $this->getReqHemoderiv(),
            $keys[32] => $this->getReqLaboratorio(),
            $keys[33] => $this->getReqAnestesico(),
            $keys[34] => $this->getStatus(),
            $keys[35] => $this->getCausaDiferidoId(),
            $keys[36] => $this->getSolicitado(),
            $keys[37] => $this->getRiesgoqxId(),
            $keys[38] => $this->getContaminacionqxId(),
            $keys[39] => $this->getEventoqxId(),
            $keys[40] => $this->getComplicaciones(),
            $keys[41] => $this->getValPreAnestesica(),
            $keys[42] => $this->getReintervencion(),
            $keys[43] => $this->getPermisos(),
            $keys[44] => $this->getTipoProcId(),
            $keys[45] => $this->getAtencionId(),
            $keys[46] => $this->getTiempoFuera(),
            $keys[47] => $this->getProcedencia(),
            $keys[48] => $this->getClasificacionqx(),
            $keys[49] => $this->getRegionPx(),
            $keys[50] => $this->getExtensionPx(),
            $keys[51] => $this->getAnexoDetalle(),
            $keys[52] => $this->getDestinoPx(),
            $keys[53] => $this->getLiberacionSala(),
            $keys[54] => $this->getTiempoEst(),
            $keys[55] => $this->getRiesgoQxPre(),
            $keys[56] => $this->getShowInIndex(),
            $keys[57] => $this->getProtocolo(),
            $keys[58] => $this->getCancelada(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setFechaControl($arr[$keys[2]]);
        if (array_key_exists($keys[3], $arr)) $this->setHora($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setInicio($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setLastTime($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setIngreso($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setSalaId($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setQuirofanoId($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setEgreso($arr[$keys[9]]);
        if (array_key_exists($keys[10], $arr)) $this->setCie9mc($arr[$keys[10]]);
        if (array_key_exists($keys[11], $arr)) $this->setCie9mcId($arr[$keys[11]]);
        if (array_key_exists($keys[12], $arr)) $this->setCxRealizada($arr[$keys[12]]);
        if (array_key_exists($keys[13], $arr)) $this->setCxRealizadaId($arr[$keys[13]]);
        if (array_key_exists($keys[14], $arr)) $this->setTipoCx($arr[$keys[14]]);
        if (array_key_exists($keys[15], $arr)) $this->setDiagnostico($arr[$keys[15]]);
        if (array_key_exists($keys[16], $arr)) $this->setDiagnosticoId($arr[$keys[16]]);
        if (array_key_exists($keys[17], $arr)) $this->setMedicoName($arr[$keys[17]]);
        if (array_key_exists($keys[18], $arr)) $this->setPacienteName($arr[$keys[18]]);
        if (array_key_exists($keys[19], $arr)) $this->setPacienteId($arr[$keys[19]]);
        if (array_key_exists($keys[20], $arr)) $this->setEdad($arr[$keys[20]]);
        if (array_key_exists($keys[21], $arr)) $this->setGenero($arr[$keys[21]]);
        if (array_key_exists($keys[22], $arr)) $this->setGeneroId($arr[$keys[22]]);
        if (array_key_exists($keys[23], $arr)) $this->setRegistro($arr[$keys[23]]);
        if (array_key_exists($keys[24], $arr)) $this->setServicio($arr[$keys[24]]);
        if (array_key_exists($keys[25], $arr)) $this->setAnestesiaId($arr[$keys[25]]);
        if (array_key_exists($keys[26], $arr)) $this->setAnestesiaEmpleada($arr[$keys[26]]);
        if (array_key_exists($keys[27], $arr)) $this->setEvAdversosAnestesia($arr[$keys[27]]);
        if (array_key_exists($keys[28], $arr)) $this->setObservaciones($arr[$keys[28]]);
        if (array_key_exists($keys[29], $arr)) $this->setRequerimiento($arr[$keys[29]]);
        if (array_key_exists($keys[30], $arr)) $this->setReqInsumos($arr[$keys[30]]);
        if (array_key_exists($keys[31], $arr)) $this->setReqHemoderiv($arr[$keys[31]]);
        if (array_key_exists($keys[32], $arr)) $this->setReqLaboratorio($arr[$keys[32]]);
        if (array_key_exists($keys[33], $arr)) $this->setReqAnestesico($arr[$keys[33]]);
        if (array_key_exists($keys[34], $arr)) $this->setStatus($arr[$keys[34]]);
        if (array_key_exists($keys[35], $arr)) $this->setCausaDiferidoId($arr[$keys[35]]);
        if (array_key_exists($keys[36], $arr)) $this->setSolicitado($arr[$keys[36]]);
        if (array_key_exists($keys[37], $arr)) $this->setRiesgoqxId($arr[$keys[37]]);
        if (array_key_exists($keys[38], $arr)) $this->setContaminacionqxId($arr[$keys[38]]);
        if (array_key_exists($keys[39], $arr)) $this->setEventoqxId($arr[$keys[39]]);
        if (array_key_exists($keys[40], $arr)) $this->setComplicaciones($arr[$keys[40]]);
        if (array_key_exists($keys[41], $arr)) $this->setValPreAnestesica($arr[$keys[41]]);
        if (array_key_exists($keys[42], $arr)) $this->setReintervencion($arr[$keys[42]]);
        if (array_key_exists($keys[43], $arr)) $this->setPermisos($arr[$keys[43]]);
        if (array_key_exists($keys[44], $arr)) $this->setTipoProcId($arr[$keys[44]]);
        if (array_key_exists($keys[45], $arr)) $this->setAtencionId($arr[$keys[45]]);
        if (array_key_exists($keys[46], $arr)) $this->setTiempoFuera($arr[$keys[46]]);
        if (array_key_exists($keys[47], $arr)) $this->setProcedencia($arr[$keys[47]]);
        if (array_key_exists($keys[48], $arr)) $this->setClasificacionqx($arr[$keys[48]]);
        if (array_key_exists($keys[49], $arr)) $this->setRegionPx($arr[$keys[49]]);
        if (array_key_exists($keys[50], $arr)) $this->setExtensionPx($arr[$keys[50]]);
        if (array_key_exists($keys[51], $arr)) $this->setAnexoDetalle($arr[$keys[51]]);
        if (array_key_exists($keys[52], $arr)) $this->setDestinoPx($arr[$keys[52]]);
        if (array_key_exists($keys[53], $arr)) $this->setLiberacionSala($arr[$keys[53]]);
        if (array_key_exists($keys[54], $arr)) $this->setTiempoEst($arr[$keys[54]]);
        if (array_key_exists($keys[55], $arr)) $this->setRiesgoQxPre($arr[$keys[55]]);
        if (array_key_exists($keys[56], $arr)) $this->setShowInIndex($arr[$keys[56]]);
        if (array_key_exists($keys[57], $arr)) $this->setProtocolo($arr[$keys[57]]);
        if (array_key_exists($keys[58], $arr)) $this->setCancelada($arr[$keys[58]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AgendaPeer::FECHA_CONTROL)) $criteria->add(AgendaPeer::FECHA_CONTROL, $this->fecha_control);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setFechaControl($this->getFechaControl());
