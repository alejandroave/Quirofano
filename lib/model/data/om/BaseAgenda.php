...
abstract class BaseAgenda extends BaseObject implements Persistent
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->ingreso = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->sala_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
            $this->quirofano_id = ($row[$startcol + 5] !== null) ? (int) $row[$startcol + 5] : null;
            $this->egreso = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
            $this->cie9mc = ($row[$startcol + 7] !== null) ? (string) $row[$startcol + 7] : null;
            $this->cie9mc_id = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
            $this->cx_realizada = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
            $this->cx_realizada_id = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
            $this->tipo_cx = ($row[$startcol + 11] !== null) ? (int) $row[$startcol + 11] : null;
            $this->diagnostico = ($row[$startcol + 12] !== null) ? (string) $row[$startcol + 12] : null;
            $this->diagnostico_id = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
            $this->paciente_name = ($row[$startcol + 14] !== null) ? (string) $row[$startcol + 14] : null;
            $this->paciente_id = ($row[$startcol + 15] !== null) ? (int) $row[$startcol + 15] : null;
            $this->edad = ($row[$startcol + 16] !== null) ? (string) $row[$startcol + 16] : null;
            $this->genero = ($row[$startcol + 17] !== null) ? (string) $row[$startcol + 17] : null;
            $this->genero_id = ($row[$startcol + 18] !== null) ? (int) $row[$startcol + 18] : null;
            $this->registro = ($row[$startcol + 19] !== null) ? (string) $row[$startcol + 19] : null;
            $this->servicio = ($row[$startcol + 20] !== null) ? (int) $row[$startcol + 20] : null;
            $this->anestesia_id = ($row[$startcol + 21] !== null) ? (int) $row[$startcol + 21] : null;
            $this->anestesia_empleada = ($row[$startcol + 22] !== null) ? (string) $row[$startcol + 22] : null;
            $this->ev_adversos_anestesia = ($row[$startcol + 23] !== null) ? (string) $row[$startcol + 23] : null;
            $this->observaciones = ($row[$startcol + 24] !== null) ? (string) $row[$startcol + 24] : null;
            $this->requerimiento = ($row[$startcol + 25] !== null) ? (string) $row[$startcol + 25] : null;
            $this->req_insumos = ($row[$startcol + 26] !== null) ? (string) $row[$startcol + 26] : null;
            $this->req_hemoderiv = ($row[$startcol + 27] !== null) ? (string) $row[$startcol + 27] : null;
            $this->req_laboratorio = ($row[$startcol + 28] !== null) ? (string) $row[$startcol + 28] : null;
            $this->req_anestesico = ($row[$startcol + 29] !== null) ? (string) $row[$startcol + 29] : null;
            $this->status = ($row[$startcol + 30] !== null) ? (int) $row[$startcol + 30] : null;
            $this->causa_diferido_id = ($row[$startcol + 31] !== null) ? (int) $row[$startcol + 31] : null;
            $this->solicitado = ($row[$startcol + 32] !== null) ? (boolean) $row[$startcol + 32] : null;
            $this->riesgoqx_id = ($row[$startcol + 33] !== null) ? (int) $row[$startcol + 33] : null;
            $this->contaminacionqx_id = ($row[$startcol + 34] !== null) ? (int) $row[$startcol + 34] : null;
            $this->eventoqx_id = ($row[$startcol + 35] !== null) ? (int) $row[$startcol + 35] : null;
            $this->complicaciones = ($row[$startcol + 36] !== null) ? (string) $row[$startcol + 36] : null;
            $this->val_pre_anestesica = ($row[$startcol + 37] !== null) ? (string) $row[$startcol + 37] : null;
            $this->reintervencion = ($row[$startcol + 38] !== null) ? (boolean) $row[$startcol + 38] : null;
            $this->permisos = $row[$startcol + 39];
            $this->tipo_proc_id = ($row[$startcol + 40] !== null) ? (int) $row[$startcol + 40] : null;
            $this->atencion_id = ($row[$startcol + 41] !== null) ? (int) $row[$startcol + 41] : null;
            $this->tiempo_fuera = ($row[$startcol + 42] !== null) ? (boolean) $row[$startcol + 42] : null;
            $this->procedencia = ($row[$startcol + 43] !== null) ? (string) $row[$startcol + 43] : null;
            $this->clasificacionqx = ($row[$startcol + 44] !== null) ? (int) $row[$startcol + 44] : null;
            $this->region_px = ($row[$startcol + 45] !== null) ? (int) $row[$startcol + 45] : null;
            $this->extension_px = ($row[$startcol + 46] !== null) ? (int) $row[$startcol + 46] : null;
            $this->anexo_detalle = ($row[$startcol + 47] !== null) ? (int) $row[$startcol + 47] : null;
            $this->destino_px = ($row[$startcol + 48] !== null) ? (int) $row[$startcol + 48] : null;
            $this->liberacion_sala = ($row[$startcol + 49] !== null) ? (string) $row[$startcol + 49] : null;
            $this->tiempo_est = ($row[$startcol + 50] !== null) ? (string) $row[$startcol + 50] : null;
            $this->riesgo_qx_pre = ($row[$startcol + 51] !== null) ? (string) $row[$startcol + 51] : null;
            $this->show_in_index = ($row[$startcol + 52] !== null) ? (boolean) $row[$startcol + 52] : null;
            $this->protocolo = ($row[$startcol + 53] !== null) ? (boolean) $row[$startcol + 53] : null;
            $this->cancelada = ($row[$startcol + 54] !== null) ? (boolean) $row[$startcol + 54] : null;
            $this->created_at = ($row[$startcol + 55] !== null) ? (string) $row[$startcol + 55] : null;
            $this->updated_at = ($row[$startcol + 56] !== null) ? (string) $row[$startcol + 56] : null;
            $this->resetModified();
            ...
            return $startcol + 57; // 57 = AgendaPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getHora(),
            $keys[3] => $this->getIngreso(),
            $keys[4] => $this->getSalaId(),
            $keys[5] => $this->getQuirofanoId(),
            $keys[6] => $this->getEgreso(),
            $keys[7] => $this->getCie9mc(),
            $keys[8] => $this->getCie9mcId(),
            $keys[9] => $this->getCxRealizada(),
            $keys[10] => $this->getCxRealizadaId(),
            $keys[11] => $this->getTipoCx(),
            $keys[12] => $this->getDiagnostico(),
            $keys[13] => $this->getDiagnosticoId(),
            $keys[14] => $this->getPacienteName(),
            $keys[15] => $this->getPacienteId(),
            $keys[16] => $this->getEdad(),
            $keys[17] => $this->getGenero(),
            $keys[18] => $this->getGeneroId(),
            $keys[19] => $this->getRegistro(),
            $keys[20] => $this->getServicio(),
            $keys[21] => $this->getAnestesiaId(),
            $keys[22] => $this->getAnestesiaEmpleada(),
            $keys[23] => $this->getEvAdversosAnestesia(),
            $keys[24] => $this->getObservaciones(),
            $keys[25] => $this->getRequerimiento(),
            $keys[26] => $this->getReqInsumos(),
            $keys[27] => $this->getReqHemoderiv(),
            $keys[28] => $this->getReqLaboratorio(),
            $keys[29] => $this->getReqAnestesico(),
            $keys[30] => $this->getStatus(),
            $keys[31] => $this->getCausaDiferidoId(),
            $keys[32] => $this->getSolicitado(),
            $keys[33] => $this->getRiesgoqxId(),
            $keys[34] => $this->getContaminacionqxId(),
            $keys[35] => $this->getEventoqxId(),
            $keys[36] => $this->getComplicaciones(),
            $keys[37] => $this->getValPreAnestesica(),
            $keys[38] => $this->getReintervencion(),
            $keys[39] => $this->getPermisos(),
            $keys[40] => $this->getTipoProcId(),
            $keys[41] => $this->getAtencionId(),
            $keys[42] => $this->getTiempoFuera(),
            $keys[43] => $this->getProcedencia(),
            $keys[44] => $this->getClasificacionqx(),
            $keys[45] => $this->getRegionPx(),
            $keys[46] => $this->getExtensionPx(),
            $keys[47] => $this->getAnexoDetalle(),
            $keys[48] => $this->getDestinoPx(),
            $keys[49] => $this->getLiberacionSala(),
            $keys[50] => $this->getTiempoEst(),
            $keys[51] => $this->getRiesgoQxPre(),
            $keys[52] => $this->getShowInIndex(),
            $keys[53] => $this->getProtocolo(),
            $keys[54] => $this->getCancelada(),
            $keys[55] => $this->getCreatedAt(),
            $keys[56] => $this->getUpdatedAt(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setIngreso($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setSalaId($arr[$keys[4]]);
        if (array_key_exists($keys[5], $arr)) $this->setQuirofanoId($arr[$keys[5]]);
        if (array_key_exists($keys[6], $arr)) $this->setEgreso($arr[$keys[6]]);
        if (array_key_exists($keys[7], $arr)) $this->setCie9mc($arr[$keys[7]]);
        if (array_key_exists($keys[8], $arr)) $this->setCie9mcId($arr[$keys[8]]);
        if (array_key_exists($keys[9], $arr)) $this->setCxRealizada($arr[$keys[9]]);
        if (array_key_exists($keys[10], $arr)) $this->setCxRealizadaId($arr[$keys[10]]);
        if (array_key_exists($keys[11], $arr)) $this->setTipoCx($arr[$keys[11]]);
        if (array_key_exists($keys[12], $arr)) $this->setDiagnostico($arr[$keys[12]]);
        if (array_key_exists($keys[13], $arr)) $this->setDiagnosticoId($arr[$keys[13]]);
        if (array_key_exists($keys[14], $arr)) $this->setPacienteName($arr[$keys[14]]);
        if (array_key_exists($keys[15], $arr)) $this->setPacienteId($arr[$keys[15]]);
        if (array_key_exists($keys[16], $arr)) $this->setEdad($arr[$keys[16]]);
        if (array_key_exists($keys[17], $arr)) $this->setGenero($arr[$keys[17]]);
        if (array_key_exists($keys[18], $arr)) $this->setGeneroId($arr[$keys[18]]);
        if (array_key_exists($keys[19], $arr)) $this->setRegistro($arr[$keys[19]]);
        if (array_key_exists($keys[20], $arr)) $this->setServicio($arr[$keys[20]]);
        if (array_key_exists($keys[21], $arr)) $this->setAnestesiaId($arr[$keys[21]]);
        if (array_key_exists($keys[22], $arr)) $this->setAnestesiaEmpleada($arr[$keys[22]]);
        if (array_key_exists($keys[23], $arr)) $this->setEvAdversosAnestesia($arr[$keys[23]]);
        if (array_key_exists($keys[24], $arr)) $this->setObservaciones($arr[$keys[24]]);
        if (array_key_exists($keys[25], $arr)) $this->setRequerimiento($arr[$keys[25]]);
        if (array_key_exists($keys[26], $arr)) $this->setReqInsumos($arr[$keys[26]]);
        if (array_key_exists($keys[27], $arr)) $this->setReqHemoderiv($arr[$keys[27]]);
        if (array_key_exists($keys[28], $arr)) $this->setReqLaboratorio($arr[$keys[28]]);
        if (array_key_exists($keys[29], $arr)) $this->setReqAnestesico($arr[$keys[29]]);
        if (array_key_exists($keys[30], $arr)) $this->setStatus($arr[$keys[30]]);
        if (array_key_exists($keys[31], $arr)) $this->setCausaDiferidoId($arr[$keys[31]]);
        if (array_key_exists($keys[32], $arr)) $this->setSolicitado($arr[$keys[32]]);
        if (array_key_exists($keys[33], $arr)) $this->setRiesgoqxId($arr[$keys[33]]);
        if (array_key_exists($keys[34], $arr)) $this->setContaminacionqxId($arr[$keys[34]]);
        if (array_key_exists($keys[35], $arr)) $this->setEventoqxId($arr[$keys[35]]);
        if (array_key_exists($keys[36], $arr)) $this->setComplicaciones($arr[$keys[36]]);
        if (array_key_exists($keys[37], $arr)) $this->setValPreAnestesica($arr[$keys[37]]);
        if (array_key_exists($keys[38], $arr)) $this->setReintervencion($arr[$keys[38]]);
        if (array_key_exists($keys[39], $arr)) $this->setPermisos($arr[$keys[39]]);
        if (array_key_exists($keys[40], $arr)) $this->setTipoProcId($arr[$keys[40]]);
        if (array_key_exists($keys[41], $arr)) $this->setAtencionId($arr[$keys[41]]);
        if (array_key_exists($keys[42], $arr)) $this->setTiempoFuera($arr[$keys[42]]);
        if (array_key_exists($keys[43], $arr)) $this->setProcedencia($arr[$keys[43]]);
        if (array_key_exists($keys[44], $arr)) $this->setClasificacionqx($arr[$keys[44]]);
        if (array_key_exists($keys[45], $arr)) $this->setRegionPx($arr[$keys[45]]);
        if (array_key_exists($keys[46], $arr)) $this->setExtensionPx($arr[$keys[46]]);
        if (array_key_exists($keys[47], $arr)) $this->setAnexoDetalle($arr[$keys[47]]);
        if (array_key_exists($keys[48], $arr)) $this->setDestinoPx($arr[$keys[48]]);
        if (array_key_exists($keys[49], $arr)) $this->setLiberacionSala($arr[$keys[49]]);
        if (array_key_exists($keys[50], $arr)) $this->setTiempoEst($arr[$keys[50]]);
        if (array_key_exists($keys[51], $arr)) $this->setRiesgoQxPre($arr[$keys[51]]);
        if (array_key_exists($keys[52], $arr)) $this->setShowInIndex($arr[$keys[52]]);
        if (array_key_exists($keys[53], $arr)) $this->setProtocolo($arr[$keys[53]]);
        if (array_key_exists($keys[54], $arr)) $this->setCancelada($arr[$keys[54]]);
        if (array_key_exists($keys[55], $arr)) $this->setCreatedAt($arr[$keys[55]]);
        if (array_key_exists($keys[56], $arr)) $this->setUpdatedAt($arr[$keys[56]]);
    }
