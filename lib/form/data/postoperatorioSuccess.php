...
<?php if($paciente): ?>
<div id="idTag">
  <div class="name"><?php echo $paciente->getPaciente() ?></div>
  <div><span class="label">Registro: </span><span><?php echo $paciente->getRegistro() ?></span></div>
</div>
<?php endif; ?>
...
<div class="menubar">
  <a href="<?php echo url_for('quirofano/show?slug='.$quirofano->getSlug()) ?>">Agenda de <?php echo $quirofano ?></a>
</div>
