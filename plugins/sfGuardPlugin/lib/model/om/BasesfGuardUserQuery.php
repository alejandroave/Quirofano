 ...
 *
 * @method sfGuardUserQuery leftJoinPersonalcirugia($relationAlias = null) Adds a LEFT JOIN clause to the query using the Personalcirugia relation
 * @method sfGuardUserQuery rightJoinPersonalcirugia($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Personalcirugia relation
 * @method sfGuardUserQuery innerJoinPersonalcirugia($relationAlias = null) Adds a INNER JOIN clause to the query using the Personalcirugia relation
 *
...
abstract class BasesfGuardUserQuery extends ModelCriteria
{
    ...
    public function filterByPersonalcirugia($personalcirugia, $comparison = null)
    {
        if ($personalcirugia instanceof Personalcirugia) {
            return $this
                ->addUsingAlias(sfGuardUserPeer::ID, $personalcirugia->getPersonalId(), $comparison);
