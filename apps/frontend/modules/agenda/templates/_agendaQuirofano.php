    ...
    <td><?php echo $cirugia->getProgramacion('Y-m-d') ?></td>
    ...
    <?php if($cirugia->getStatus() < 0 ): ?>
      ...
      <a href="<?php echo url_for('quirofano/cancelar?id='.$cirugia->getId()) ?>" title="Cancelar cirugía"><div class="cancelar"></div></a>
